    ...
    <section  className=' py-24 px-3 bg-[#F6F5FF]'>
        ...
        <div className="pb-5">
                ...
                <div className="flex justify-between bg-[#fff]  px-4 pb-24">
                    ...
                    <div className="w-[49%]">
                       ...
                       <h2 className='font-Sans font-bold text-[32px]  text-[#0D0E43]'>Contact Way</h2>
                        <div className="flex justify-between">
                           <div className="w-[50%]">
                           <div className=" relative after:absolute after:contain-[''] after:top-[5px] after:left-0 after:h-[20px] after:w-[20px] after:bg-[#5726DF] after:rounded-full">
                            ...
                            <div className="w-[50%]">
                            <div className=" relative after:absolute after:contain-[''] after:top-[5px] after:left-0 after:h-[20px] after:w-[20px] after:bg-[#FF27B7] after:rounded-full">
                        ...
                        <div className="flex justify-between mt-14">
                            <div className="w-[50%]">
                            <div className=" relative after:absolute after:contain-[''] after:top-[5px] after:left-0 after:h-[20px] after:w-[20px] after:bg-[#FFB265] after:rounded-full">
                           ...
                           <div className="w-[50%]">
                           <div className=" relative after:absolute after:contain-[''] after:top-[5px] after:left-0 after:h-[20px] after:w-[20px] after:bg-[#1BE982] after:rounded-full">
                    ...
                    <div className="mt-40">
                        <img className='space-x-5 h-[80%] w-[80%]' src={contact} alt="" />
                    </div>
                    </div>
                </div>
        </Container>
